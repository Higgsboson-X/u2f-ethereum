...
function u2fEnroll(appId, address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank.enroll(appId, {from: address}, async (e, txn) => {
            if (e) {
                console.log(e);
                reject(e);
            }
...
function u2fBind(appId, address, response) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank.client(decodedClientData, appId, 0, {from: address}, (e, challengeParameter) => {
            ...
            ethBank.bind(appId, challengeParameter, pubKey, keyHandle, certKey, signature, {from: address}, (err, txn) => {
                ...
                ethBank._registeredKey({from: address}, (error, device) => {
...
function u2fSign(appId, address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank.sign(appId, {from: address}, async (e, txn) => {
            if (e) {
                console.log(e);
                reject(e);
            }
...
function u2fVerify(appId, address, response) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank.client(decodedClientData, appId, 1, {from: address}, (e, challengeParameter) => {
            ...
            ethBank.verify(appId, challengeParameter, decodedSignatureData, keyHandle, {from: address}, (err, txn) => {
                ...
                ethBank._lastVerified({from: address}, (error, verification) => {
...
function getRegisterRequest(address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank._enroll({from: address}, (e, request) => {
...
function getRegisteredKey(address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank._registeredKey({from: address}, (e, device) => {
...
function getSignRequest(address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank._sign({from: address}, (e, request) => {
...
function getLastVerified(address) {
    ...
    return new Promise((resolve, reject) => {
        ...
        ethBank._lastVerified({from: address}, (e, verification) => {
